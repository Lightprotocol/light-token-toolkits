/**
 * Unwrap c-Tokens to SPL using instructions
 *
...
async function main() {
  ...
  const tx = new Transaction().add(
    ...(await createLoadAtaInstructions(rpc, ctokenAta, payer.publicKey, mint, payer.publicKey)),
    createUnwrapInstruction(ctokenAta, splAta, payer.publicKey, mint, amount, splInterfaceInfo)
  );
